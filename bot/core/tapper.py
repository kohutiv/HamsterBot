        ...
        while True:
            try:
                ...
                if time() - access_token_created_time >= 3600:
                        ...
                        if not is_claimed:
                            ...
                            if start_bonus_round <= datetime.now() < end_bonus_round:
                                ...
                                if balance < common_price:
                                    logger.info(f"{self.session_name} | "
                                                f"<lr>Daily combo is not applicable</lr>, you don't have enough "
                                                f"coins. Need <ly>{common_price:,}</ly> coins, but your balance is "
                                                f"<lr>{balance:,}</lr> coins")
                    ...
                    await asyncio.sleep(delay=randint(2, 14))
                    ...
                    await asyncio.sleep(delay=randint(2, 16))
